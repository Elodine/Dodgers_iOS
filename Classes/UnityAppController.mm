...
bool    _ios110orNewer          = false;
bool    _ios111orNewer          = false;
bool    _ios112orNewer          = false;
...
void UnityInitTrampoline()
{
    ...
    _ios110orNewer = [version compare: @"11.0" options: NSNumericSearch] != NSOrderedAscending;
    _ios111orNewer = [version compare: @"11.1" options: NSNumericSearch] != NSOrderedAscending;
    _ios112orNewer = [version compare: @"11.2" options: NSNumericSearch] != NSOrderedAscending;
